...
\begin{itemize}
  ...
  \item For features answered on a scale from 1 to 5, the first character of the string response was converted to an integer, to treat the feature as numerical.
  \item Multi-select survey responses were converted into binary features.
\end{itemize}
